...
fun EditText.eventWriten(context: ListDynamicAdapter.MyViewHolder) {
...
fun LinearLayout.eventImageCheckBoxDynamic(context: ListDynamicAdapter.MyViewHolder, imageView: ImageView) {
